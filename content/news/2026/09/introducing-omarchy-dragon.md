...
description: Meet the four people bringing Omarchy to Snapdragon laptops, from installation and recovery to battery life, sleep, drivers, and upstream Linux fixes.
---
...
Four people are already working on the pieces:
...
This is work in progress, with compatibility being worked through machine by machine. But we now have a team taking responsibility for it, testing on real hardware, and pushing fixes upstream. Welcome, Jim, Birk, Matt, and Bob. Let's bring beautiful, fun & agentic Linux to Snapdragon!
